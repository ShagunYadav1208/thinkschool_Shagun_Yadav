...
var jwtIssuer = builder.Configuration["Jwt:Issuer"] ?? "QuotesSqlServerApi";
var jwtAudience = builder.Configuration["Jwt:Audience"] ?? "QuotesSqlServerApi.Client";
...
{
    message = "Day 3 Piece 6: WebApplicationFactory tests against real SQL Server via Testcontainers.",
    endpoints = new[]
    {
        "POST /auth/token",
        "GET /api/quotes",
