...
public static class QuoteEndpointExtensions
{
    public static void MapQuoteEndpoints(this WebApplication app)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            // the DB delete above already committed - a cache-layer hiccup (confirmed live in
            // day-25: Redis unreachable locally throws RedisConnectionException here) shouldn't
            // turn an already-successful delete into a failed request. Worst case without this
            // eviction, the stale entry just serves until its existing TTL (30s) expires on its
            // own.
            try
            {
