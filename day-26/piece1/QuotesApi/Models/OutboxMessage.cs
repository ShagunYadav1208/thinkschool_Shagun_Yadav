...
public class OutboxMessage
{
    ...
    // brand new, disconnected trace instead of continuing the one the request started. This is
    // what makes "the trace stitches API -> worker -> DB" true across an async/durable boundary,
    // not just within one request's own call stack.
